...
/**
 * Register push notification listeners and request permissions on Capacitor native platforms or Web Push
 */
    ...
    try {
      ...
      PushNotifications.addListener('registration', async (token) => {
        ...
        try {
          ...
          await apiClient.post('/notifications/register-fcm', {
            token: token.value,
            device: deviceInfo
          });
      ...
      PushNotifications.addListener('pushNotificationReceived', (notification) => {
        ...
        // Optional: Add top notification banners or badges if required
      });
